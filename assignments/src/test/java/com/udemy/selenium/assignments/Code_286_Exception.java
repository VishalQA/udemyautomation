...
public class Code_286_Exception {


//one try can be followed by mutiplle catch blocks //catch should be an immediate block after try // public class exceptionDemo { 
